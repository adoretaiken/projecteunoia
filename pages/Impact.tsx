...
const Impact = () => {
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      <SEO title="Impact Dashboard | Eunoia Society" description="Live metrics and resource allocation data." />
      <div className="mb-12">
          ...
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data}>
                ...
                <YAxis stroke="#000" tick={{fontWeight: 'bold'}} domain={[0, 300]} />
                <Tooltip 
