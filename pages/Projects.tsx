...
const Projects = () => {
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      <SEO title="Operations | Eunoia Society" description="Archive of our active and completed projects across Bangladesh." />
      <RevealOnScroll className="mb-12 border-b-4 border-black pb-8">
        ...
        <p className="text-xl md:text-2xl font-bold opacity-70">A complete archive of our active and completed projects.</p>
      </RevealOnScroll>

      <div className="flex flex-wrap gap-4 mb-12">
        <BrutalistButton variant="primary" size="sm">All</BrutalistButton>
        <BrutalistButton variant="outline" size="sm">Traffic</BrutalistButton>
        ...
        <BrutalistButton variant="outline" size="sm">Environment</BrutalistButton>
        <BrutalistButton variant="outline" size="sm">Safety</BrutalistButton>
        <BrutalistButton variant="outline" size="sm">Livelihood</BrutalistButton>
        <BrutalistButton variant="outline" size="sm">Housing</BrutalistButton>
        <BrutalistButton variant="outline" size="sm">Governance</BrutalistButton>
