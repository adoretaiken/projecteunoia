...
const Home = () => {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative px-6 md:px-12 py-12 md:py-24 max-w-screen-2xl mx-auto overflow-hidden">
        <LineReveal className="mb-8 md:mb-12" />
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end mb-12 md:mb-20">
          <div className="lg:col-span-8">
            <RevealOnScroll delay={0.1}>
              <h1 className="text-[clamp(3.5rem,14vw,14rem)] font-header uppercase tracking-[-0.05em] leading-[0.85] select-none">
                FIXING <br/> WHAT <br/> <span className="text-[#0338bb]">MATTERS.</span>
              </h1>
            </RevealOnScroll>
          </div>
          <div className="lg:col-span-4 lg:pl-12">
            <RevealOnScroll delay={0.3}>
              <p className="text-lg md:text-xl font-medium mb-10 text-black/40 leading-tight uppercase tracking-widest">
                Focused on stabilizing structural problems across Bangladesh.
              </p>
              <div className="flex flex-wrap gap-6">
                <Link to="/report">
                  <BrutalistButton variant="accent">Report a Problem</BrutalistButton>
                </Link>
                <Link to="/projects">
                  <BrutalistButton variant="outline">View Operations</BrutalistButton>
                </Link>
              </div>
            </RevealOnScroll>
          </div>
        ...
        <LineReveal className="mt-8 md:mt-12" />
      </section>
      ...
      <section className="bg-slate-50 py-24 md:py-48 px-6 md:px-12 border-b-[4px] border-black">
        <div className="max-w-screen-2xl mx-auto">
          <div className="mb-24 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <RevealOnScroll>
              <h2 className="text-5xl md:text-8xl font-header uppercase">HOW WE WORK</h2>
            </RevealOnScroll>
            <p className="max-w-md text-sm font-bold opacity-30 uppercase tracking-[0.2em] leading-snug">
              Spot the problem. Break it down. Test solutions. Scale what works.
            </p>
          </div>
          
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
            {[
              { title: "IDENTIFY", desc: "Collect stories, observe daily struggles, and find the gaps." },
              { title: "SPRINTS", desc: "Test small fixes on the ground to see what actually helps." },
              { title: "IMPLEMENT", desc: "Take what works and make it permanent. Build real solutions that last." },
              { title: "HANDOVER", desc: "Hand it over to the local people. Give them the tools to keep it running." }
            ].map((item, i) => (
              <StaggerItem key={i}>
                <motion.div 
                  ...
                  whileHover={{ 
                    ...
                    y: -8,
                    x: -8,
                    boxShadow: "16px 16px 0px 0px #FF6600"
                  }}
      ...
      <section className="bg-white py-24 md:py-48 px-6 md:px-12 border-b-[4px] border-black">
        <div className="max-w-screen-2xl mx-auto">
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 gap-0 border-[4px] border-black bg-white">
      ...
      <section className="bg-black text-white py-48 md:py-72 px-6 md:px-12 relative overflow-hidden">
        <div className="max-w-screen-2xl mx-auto text-center relative z-10">
          <RevealOnScroll>
            ...
            <div className="flex flex-col md:flex-row justify-center gap-10">
              <Link to="/join">
                <BrutalistButton variant="accent" size="lg">JOIN THE MOVEMENT</BrutalistButton>
              </Link>
              <Link to="/contact">
                <BrutalistButton variant="outline" size="lg" className="!bg-white !text-black !border-white">REACH OUT</BrutalistButton>
              </Link>
            </div>
          </RevealOnScroll>
        </div>
        ...
        <div className="absolute inset-0 opacity-5 pointer-events-none select-none overflow-hidden">
          <div className="text-[20rem] font-header uppercase leading-none absolute -bottom-20 -left-20 whitespace-nowrap">DO MORE</div>
          <div className="text-[20rem] font-header uppercase leading-none absolute -top-20 -right-20 whitespace-nowrap">BE MORE</div>
        </div>
      </section>
    </div>
  );
